...
if __name__ == '__main__':
    ...
    corpus = HTMLCorpusReader('clean_recipes')
    prep = Preprocessor(corpus, 'clean_recipes_proc')
    docs = prep.transform()
    # transformer = ProgressParallelPreprocessor(corpus, 'clean_recipes_proc')
    # docs = transformer.transform()
    print(len(list(docs)))

    pkl_corpus = HTMLPickledCorpusReader('clean_recipes_proc')
    print(list(pkl_corpus.titles()))